...
export default function DepartmentsPage() {
  return (
    <div className="flex flex-col items-center min-h-screen pt-16 sm:pt-20 lg:pt-24 pb-12 sm:pb-16 px-3 sm:px-4 lg:px-8 text-white">
      <div className="w-full max-w-7xl">
        ...
        <div className="text-center mb-6 sm:mb-8">
          <a 
            ...
            className="inline-flex items-center gap-2 sm:gap-3 bg-[#5865F2] hover:bg-[#4752C4] text-white font-semibold py-2 sm:py-3 px-4 sm:px-6 rounded-lg transition-colors duration-200 shadow-lg hover:shadow-xl text-sm sm:text-base"
          >
        ...
        <div className="text-center mb-8 sm:mb-12">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold mb-3 sm:mb-4 drop-shadow-lg">City Services</h1>
                ...
                <div className="flex items-start gap-3 sm:gap-4 mb-3 sm:mb-4">
                  <div className="relative">
                    <Image 
                      ...
                      width={60} 
                      height={60} 
                      className="sm:w-[80px] sm:h-[80px] rounded-lg object-contain bg-white/10 p-1 sm:p-2" 
                    />
                    <Badge className={`absolute -top-1 -right-1 sm:-top-2 sm:-right-2 text-white text-xs px-1.5 sm:px-2 py-0.5 sm:py-1 ${
                  ...
                  <div className="flex-1">
                    <h2 className="text-lg sm:text-xl font-bold mb-1">{dept.name}</h2>
                    <p className="text-xs sm:text-sm text-white/60 font-semibold">{dept.shortName}</p>
                  </div>
                </div>
