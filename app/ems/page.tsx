        ...
        <div className="max-w-6xl w-full grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex flex-col items-center space-y-6">
            <div className="relative">
              <Image src="/SAFR.png" alt="EMS" width={400} height={300} className="rounded-2xl object-contain bg-white/10 p-8 backdrop-blur-sm border border-white/20" />
              <Badge className="absolute -top-3 -right-3 bg-green-600 text-white text-sm px-3 py-1">NOW HIRING</Badge>
            </div>
          </div>
          ...
          <Card className="bg-neutral-900/95 backdrop-blur-md p-12 rounded-2xl shadow-2xl border border-white/10">
            <div className="space-y-8">
              <div>
                <h1 className="text-4xl font-bold mb-2 text-white">Emergency Medical Services</h1>
                <p className="text-green-300 text-lg font-semibold">Saving Lives Every Day</p>
              </div>
              ...
              <div className="pt-4">
                <Button asChild className="w-full bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white font-semibold text-lg py-6 rounded-xl shadow-lg transform hover:scale-105 transition-all duration-200">
