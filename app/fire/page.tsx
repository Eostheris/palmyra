        ...
        <div className="max-w-6xl w-full grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex flex-col items-center space-y-6">
            <div className="relative">
              <Image src="/SAFR.png" alt="Fire Department" width={400} height={300} className="rounded-2xl object-contain bg-white/10 p-8 backdrop-blur-sm border border-white/20" />
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                <p className="text-white/90 text-lg leading-relaxed">
                  When disaster strikes, we answer the call. Palmyra Fire Department handles structure fires, vehicle accidents, 
