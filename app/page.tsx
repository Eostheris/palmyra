    ...
    <main className="min-h-screen w-full text-white flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <section className="flex flex-col items-center justify-center min-h-screen w-full text-center px-4 sm:px-6 lg:px-8 relative">
        <div className="relative z-10 max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold mb-4 sm:mb-6 drop-shadow-lg text-white">
            Palmyra RP
          </h1>
          
          {/* Text Container with Transparency */}
          <div className="bg-black/40 backdrop-blur-sm border border-white/20 rounded-2xl p-6 sm:p-8 mb-6 sm:mb-8 shadow-2xl">
            <p className="text-lg sm:text-xl md:text-2xl max-w-2xl mx-auto drop-shadow-lg text-white/95 leading-relaxed">
