// TypeScript definitions for Penal Code
...
/**
 * @typedef {"Felony" | "Misdemeanor" | "Infraction"} PenalCodeClass
 */

/**
 * @typedef {Object} PenalCodeStatute
 * @property {string} id
 * @property {string} title
 * @property {PenalCodeClass} class
...
/**
 * @typedef {Object} PenalCode
 * @property {string} Title
 * @property {Record<number, PenalCodeStatute>} Statutes
 */
